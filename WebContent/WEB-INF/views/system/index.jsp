...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"5","icon":"","menuname":"学生课程管理",
                        			"menus":[
                        					{"menuid":"51","menuname":"课程信息","icon":"icon-user-student","url":"../course/list"},
                        			]
                        },
                        {"menuid":"6","icon":"","menuname":"学生成绩管理",
                                    "menus":[
                                            {"menuid":"61","menuname":"成绩信息","icon":"icon-user-student","url":"../success/list"},
                                    ]
                        },
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">学生课程管理系统</span>
    </div>
